...
then
  ...
  cf map-route green-${app_name}apps.pcf.cloudnativeappdemos.net --hostname ${app_host}
  ...
  cf map-route blue-${app_name}apps.pcf.cloudnativeappdemos.net --hostname ${app_host}
  echo "Sleeping for 15 seconds"
  sleep 15s
